...
int [] sync= new int[0];
  ...
  private void regle5() throws Exception {
    ...
    x_4.analyser() ;
      action_attr_5(x_3, x_4, x_6);
    x_6.analyser() ;
      action_tds_5(x_3, x_4, x_6);
  }
private void action_tds_5(T_MJAVA x_3, S_SUPER_MJAVA x_4, S_CORPS_MJAVA x_6) throws Exception {
try {
// locales
INFO loc_info;
DTYPE loc_t;
...
if (loc_info!=null){
att_scanner._interrompre(IProblem.Semantic, att_scanner.getBeginLine(), IMJAVAMessages.id_err_ident_already_known, MJAVAMessages.err_ident_already_known,new Object[]{""+"L'interface", ""+x_3.att_txt});
...
private void action_attr_5(T_MJAVA x_3, S_SUPER_MJAVA x_4, S_CORPS_MJAVA x_6) throws Exception {
try {
// instructions
