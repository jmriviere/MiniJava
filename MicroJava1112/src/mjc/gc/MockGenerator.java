...
public class MockGenerator implements IGenerator {
	...
	@Override
	public String concatenateArgument(String att_code, String att_code2) {
	...
	@Override
	public String generateClazz(Clazz glob_4_clazz) {
		// TODO Auto-generated method stub
		return "";
	}
	...
	@Override
	public String concatenateEntities(String att_code, String att_code2) {
		// TODO Auto-generated method stub
		return "";
	}
